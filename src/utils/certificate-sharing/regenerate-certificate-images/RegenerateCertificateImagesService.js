...
async function generateCertificateImageAsync(certProgress) {
    ...
    imageGenerator.generateCertificateImage(
        ...
        `https://platform-ui.${imageDomain}.com/learn/${certProgress.provider}/${certProgress.certification}/${handle}/certificate`,
...
async function processCompletedWithNoImageUrl(completedCertifications) {
    ...
    noImageExists
        .forEach(certProgress => generateCertificateImageAsync(token, certProgress))
}
