...
module.exports = {
  ...
  AMAZON: {
    LOCAL_AWS_ACCESS_KEY_ID: process.env.AWS_ACCESS_KEY_ID || 'FAKE_ACCESS_KEY',
    LOCAL_AWS_SECRET_ACCESS_KEY: process.env.AWS_SECRET_ACCESS_KEY || 'FAKE_SECRET_ACCESS_KEY',
    LOCAL_AWS_SESSION_TOKEN: process.env.AWS_SESSION_TOKEN || 'FAKE_SESSION_TOKEN',
